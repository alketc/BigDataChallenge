...
public class GraphPlotter2 {

	private XYSeriesCollection dataset;
	private ChartPanel chartpanel;
	
	public GraphPlotter2(String title, String xlabel, String ylabel, String[] domain) {
		dataset = new XYSeriesCollection();
		dataset.setAutoWidth(true);
		JFreeChart jfreechart = ChartFactory.createXYLineChart(title, xlabel == null ? "" : xlabel, ylabel == null ? "" : ylabel, dataset, PlotOrientation.VERTICAL, true, false, false);
	...
	public static void main(String args[]) throws Exception {
        ...
        dst.addValue(1.0, "marzo", "2015");
        dst.addValue(22.0, "April", "2015");
        dst.addValue(12.0, "febbraio", "2015");
		JFreeChart BarChartObject=ChartFactory.createBarChart("Subject Vs Marks - Bar Chart","Subject","Marks",
				dst,PlotOrientation.VERTICAL,true,true,false);  
		
		GraphPlotter2 gp = drawGraph("Main Frame","Title",
				"s1", "xlabel", "ylabel",new String[]{"a","b","c","d"},new double[]{1,4,9,16});
		...
		GraphPlotter2[] gps = drawMultiGraph(2,2,"Main Frame",titles, "xlabel", "ylabel",labels, domains,data);
		gps[2].addData("s2",new double[]{1,2,3,4});
		
	}

	public static GraphPlotter2 drawGraph(String frameTitle, String title, String label,
			                             String xlabel, String ylabel, String[] domain, 
			                                                                  double[] data){
		JFrame frame = new JFrame(frameTitle);
		frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		GraphPlotter2 panel = new GraphPlotter2(title,xlabel,ylabel,domain);
	...
	public static GraphPlotter2[] drawMultiGraph(int n_panel_x, int n_panel_y, String frameTitle, List<String> titles, String xlabel, String ylabel, List<String> labels, List<String[]> domains, List<double[]> data)  {
		...
		GraphPlotter2[] panel = new GraphPlotter2[domains.size()];
		for (int i = 0; i < domains.size(); i++) {
			panel[i]  = new GraphPlotter2(titles.get(i),xlabel,ylabel,domains.get(i));
