...
public class TestRserve {
	...
	public static void drawBar2(String[] x, List<double []> y, List<String> names, String kind, String xlab, String ylab, 
			                                                                                   String file, String opts) {
		try {
	...
	public static void drawMyGraphics(double[] x, String file, String opts) {
		try {
...
//		names.add("ok3");
		...
		//drawBar2(new String[]{"a","b","c"},l,names,"types","x","y","C:/Users/Alket/luna/Rserve/images/test4.pdf",null);
		//drawMyGraphics(new double[]{2, 3, 4},"Images/testMytest.pdf",null);
